...
#ifndef VCONNECT_SYNTH_H
#define VCONNECT_SYNTH_H
...
class vConnectSynth : public QObject, public ISynth
{
    Q_OBJECT
...
protected:
    ...
    bool isResampler;
    QString voiceName;
    QMap<QString,QString> voicesMap;
    int _tempo;
